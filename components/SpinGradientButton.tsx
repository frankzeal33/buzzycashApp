...
const SpinGradientButton = ({ title, handlePress, containerStyles, bgColor, textStyles, isLoading, disableButton, gradientColors = ['#FFAE4D', '#EF4734'] }: buttonProps) => {
  return (
...
export default SpinGradientButton