  ...
  return (
    <View className='w-full bg-white rounded-xl mb-3 p-4'>
      ...
      <View className='flex-row items-center justify-between gap-2 mt-3 w-full'>
        ...
        <IconButton title='PURCHASE TICKET' handlePress={() => router.push("/(protected)/(routes)/AllTickets")} textStyles='text-white' icon={<MaterialCommunityIcons name="ticket-outline" size={18} color="white" />} containerStyles='bg-blue w-[58%] px-2'/>
      </View>
    </View>
  )
}